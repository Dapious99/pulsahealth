...
export const metadata: Metadata = {
  ...
  description:
    "The AI models, cloud infrastructure, and NVIDIA GPU stack powering Pulsa Health's real-time triage engine.",
  openGraph: {
    title: "Technology & Infrastructure — Pulsa Health",
    description:
      "AWS, NVIDIA, and multilingual AI powering healthcare triage at scale.",
    url: "/technology",
  },
        ...
        <section className="py-24">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
              Four models work in concert — each audited, each with a human reviewer in the loop,
              each improving weekly on confirmed outcome data.
            </p>
